...
TypeId MmWaveEnbNetDevice::GetTypeId ()
{
  static TypeId
   ...
   .AddAttribute ("EnableE2FileLogging",
                   ...
                   MakeBooleanChecker ())
     // add output tracefile              
    .AddAttribute ("TracePath",
                   "TracePath for saving Trace File",
                   StringValue(""),
          ...
          if (m_e2term != 0)
            {
              ...
              if (m_forceE2FileLogging) {
                ...
                m_cuCpFileName = m_TracePath +"cu-cp-cell-" + std::to_string(m_cellId) + ".txt";
                ...
                m_duFileName =m_TracePath + "du-cell-" + std::to_string(m_cellId) + ".txt";
